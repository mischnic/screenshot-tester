...
str.setAttribute(
	FontAttribute.newBackgroundColor(new libui.Color(0, 0, 1, 1)),
	0,
	Buffer.from("👨🏻").length
);
...
str.appendAttributed(
	...
	FontAttribute.newBackgroundColor(new libui.Color(0.5, 0.5, 0.25, 0.5))
);
str.appendUnattributed(", ");
...
str.appendAttributed(
	"underline color",
	FontAttribute.newUnderline(FontAttribute.underline.double),
	FontAttribute.newUnderlineColor(
		FontAttribute.underlineColor.custom,
...
str.appendAttributed(
	"And multiple attributes at once!",
